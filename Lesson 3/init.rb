...
p train6 = Train.new(12, "pass", 6)
p train7 = Train.new(13, "gruz", 7)
puts '-*-' * 15

puts "Первый поезд набирает скорость (без параметров)"
train6.accelerate
puts "Текущая скорость поезда:"
puts train6.speed

puts '-*-' * 15
puts "Первый поезд набирает скорость (+20 км/ч)"
...
train6.stop
puts "Текущая скорость поезда: #{train6.speed}"
puts '-*-' * 15
...
puts "В составе поезда #{train6} - #{train6.carriage} вагонов."
puts '-*-' * 15
