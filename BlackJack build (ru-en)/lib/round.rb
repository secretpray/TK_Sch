...
class Round
  ...
  def skip_step
    raise Localization.translate(:one_skip) unless skip_player.zero?
  ...
  def add_card(player)
    raise Localization.translate(:have_three_cards) if players_three_cards?
