...
# Русские крякозябры решатюся либо force_encoding(Encoding::UTF_8)
# либо обёрткой строки String#mb_chars в activesupport (из состава Rails, но может использоваться отдельно).
